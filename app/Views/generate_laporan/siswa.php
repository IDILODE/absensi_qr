...
<head>
    <style>
        ...
        /* Flexbox untuk Bulan dan Kelas Berdampingan */
        .header-info {
            display: flex;
            /* Menjadikan header-info sebagai flex container */
            justify-content: space-between;
            /* Menjaga elemen di kiri dan kanan */
            align-items: center;
        ...
        .header-info span:first-child {
            margin-right: 20px;
            /* Menambahkan jarak setelah "Bulan" */
        }
    </style>
</head>
...
<body>
    ...
    <div class="content">
        <div class="header-info">
            ...
            <span><strong>Kelas:</strong> <?= $namaKelas; ?> <?= $jurusan; ?></span>
        </div>
        ...
        <table class="attendance-table">
            <thead>
                <tr>
                    <th rowspan="3">No</th>
                    <th rowspan="3" style="width: 20%;">Nama Siswa</th>
            ...
            <tbody>
                ...
                foreach ($siswa_list as $siswa): ?>
                    <tr>
                        <td><?= $no++; ?></td>
                        <td style="text-align:left; width: 20%;"><?= $siswa['nama_siswa']; ?></td>
                ...
                <?php
                            $kehadiran = $siswa['absensi'][$tanggal] ?? null;
